...
const mockBooks = [
  ...
  { id: 5, title: "The Great Gatsby", cover: "https://m.media-amazon.com/images/I/41-KqB1-cqL._SY346_.jpg", status: "Want to Read" },
  { id: 6, title: "Moby-Dick", cover: "https://m.media-amazon.com/images/I/41-KqB1-cqL._SY346_.jpg", status: "Want to Read" }, 
  { id: 7, title: "The Great Gatsby", cover: "https://m.media-amazon.com/images/I/41-KqB1-cqL._SY346_.jpg", status: "Want to Read" },
  { id: 8, title: "Moby-Dick", cover: "https://m.media-amazon.com/images/I/41-KqB1-cqL._SY346_.jpg", status: "Want to Read" },
];
...
export default function UserFavoritesScreen() {
  ...
  const removeAuthor = (id) => {
    console.log('removing author', id)
  ...
  return (
    <div className="container">
      ...
      <div className="mt-3">
        {activeTab === "books" && (
          <BookShelfTab books={books} changeStatus={changeStatus} removeBook={removeBook} />
        )}
